<?php
  ...
  class ProductoRepository implements IProducto {
    ...
    public function actualizarProducto($producto) {
      $sql = "UPDATE productos SET nombre = :nombre, descipcion = :descripcion, tipo = :tipo, precio = :precio, imagen = :imagen WHERE idproducto = :idproducto";
      $resultado = $this->conn->prepare($sql);
      ...
      $resultado->bindParam(':imagen', $producto->imagen);
      if ($resultado->execute()) {
        return ['mesaje' => 'Producto Actualizado'];
      }
      return ['mensaje' => 'Error al crear el producto'];
    }
    public function borrarProducto($idproducto) {
      ...
      if ($resultado->execute()) {
        return ['mesage' => 'Error al borrar producto'];
      }
    }
